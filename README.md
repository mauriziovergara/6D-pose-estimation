...
- Download from [Linemod_preprocessed](https://drive.google.com/drive/folders/19ivHpaKm9dOrr12fzC8IDFczWRPFxho7)
- Extract to `Linemod_preprocessed/` directory
- Verify structure matches the layout above

**(Alternative) Copy Linemod_preprocessed folder on Google Drive - MyDrive**
...
- `--add_thresh`: ADD threshold multiplier (default: = 0.1×diameter)
...
- **LineMOD Dataset**: [Link](https://drive.google.com/drive/folders/19ivHpaKm9dOrr12fzC8IDFczWRPFxho7)
- **YOLO**: Ultralytics YOLOv8 [GitHub](https://github.com/ultralytics/ultralytics)

## Contact

- Author: Maurizio Pio Vergara
- Email: s346643@studenti.polito.it / vergara.maurizio98@gmail.com
- Repository: [\[GitHub URL\]](https://github.com/mauriziovergara/6D-pose-estimation)
